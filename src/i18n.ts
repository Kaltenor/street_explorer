...
export const STRINGS = {
  en: {
    ...
    map: {
      ...
      backupFailedVerifyMessage: "The backup was shared, but the saved Files copy could not be verified.",
      backupVerifiedMessage: "{size} | {sessions} walks | {points} GPS points | {blocks} archive blocks. The selected Files copy was fully verified.",
      backupFailedTitle: "Backup failed",
      backupVerifiedTitle: "Backup verified",
      ...
      legacyConversionFailedMessage: "Street Explorer could not convert this V4 JSON backup.",
      legacyConversionFailedPrepareMessage: "This file is not a complete Street Explorer V4 JSON backup.",
      legacyConversionFailedTitle: "V4 conversion failed",
      legacyConversionMessage: "{size} | {sessions} walks | {points} GPS points | {blocks} archive blocks. The converted Files copy was fully verified.",
      legacyConversionTitle: "V4 converted to V5",
    ...
    history: {
      ...
      conversionProcessing: "V4 conversion in progress...",
      dataOperationHint: "Please wait. A large history can take several seconds.",
      convertLegacyBackup: "Convert V4",
      delete: "Delete",
      diagnostics: "Diagnostics",
      ended: "Ended",
      ...
      restoreProcessing: "Restore in progress...",
      frozenRoute: "Frozen",
      ...
      reprocessWalk: "Reprocess this walk",
      reprocessWalkBusy: "Reprocessing...",
  ...
  fr: {
    ...
    map: {
      ...
      backupFailedVerifyMessage: "La sauvegarde a \u00e9t\u00e9 partag\u00e9e, mais la copie enregistr\u00e9e dans Fichiers n'a pas pu \u00eatre v\u00e9rifi\u00e9e.",
      backupVerifiedMessage: "{size} | {sessions} marches | {points} points GPS | {blocks} blocs d'archive. La copie s\u00e9lectionn\u00e9e dans Fichiers a \u00e9t\u00e9 enti\u00e8rement v\u00e9rifi\u00e9e.",
      ...
      backupVerifiedTitle: "Sauvegarde v\u00e9rifi\u00e9e",
      ...
      legacyConversionFailedMessage: "Street Explorer n'a pas pu convertir cette sauvegarde JSON V4.",
      legacyConversionFailedPrepareMessage: "Ce fichier n'est pas une sauvegarde JSON V4 compl\u00e8te de Street Explorer.",
      legacyConversionFailedTitle: "Conversion V4 impossible",
      legacyConversionMessage: "{size} | {sessions} marches | {points} points GPS | {blocks} blocs d'archive. La copie convertie dans Fichiers a \u00e9t\u00e9 enti\u00e8rement v\u00e9rifi\u00e9e.",
      legacyConversionTitle: "V4 convertie en V5",
    ...
    history: {
      backup: "Sauvegarder",
      backupProcessing: "Sauvegarde en cours...",
      conversionProcessing: "Conversion V4 en cours...",
      dataOperationHint: "Veuillez patienter. Un historique volumineux peut prendre plusieurs secondes.",
      delete: "Supprimer",
      convertLegacyBackup: "Convertir V4",
      diagnostics: "Diagnostic",
      ended: "Fin",
      ...
      restoreProcessing: "Restauration en cours...",
      ...
      reprocessWalk: "Recalculer cette marche",
      reprocessWalkBusy: "Recalcul en cours...",
