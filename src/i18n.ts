...
export const STRINGS = {
  en: {
    ...
    map: {
      ...
      bulkGpxExportedMessage: "{size} | {sessions} walks | {points} GPS points. The ZIP contains one GPX file per finalized walk.",
      bulkGpxExportedTitle: "GPX archive exported",
      bulkGpxExportFailedMessage: "Street Explorer could not export the GPX archive.",
      bulkGpxExportFailedTitle: "GPX export failed",
    ...
    history: {
      ...
      restorePreviewProcessing: "Checking backup...",
      frozenRoute: "Frozen",
  ...
  fr: {
    ...
    map: {
      ...
      bulkGpxExportedMessage: "{size} | {sessions} marches | {points} points GPS. Le ZIP contient un fichier GPX par marche finalis\u00e9e.",
      bulkGpxExportedTitle: "Archive GPX export\u00e9e",
      bulkGpxExportFailedMessage: "Street Explorer n'a pas pu exporter l'archive GPX.",
      bulkGpxExportFailedTitle: "Export GPX impossible",
    ...
    history: {
      ...
      restorePreviewProcessing: "V\u00e9rification de la sauvegarde...",
