...
- iOS-first Midnight Cartographer playfield with dark muted MapKit, hidden native POIs/cursor, light-orange explored territory, gold current activity, burnt-orange district boundaries, red city boundaries, restrained route colors, and hand-inked atlas markers.
- Atlas identity pass: original hand-inked cartographer player, gold cartographic shells for Details/History/Completion/Options, textured navy paper, quiet UI sounds, Reduce Motion-aware transitions, map objective stamps, explored-area ink reveal, saved-route draw-on focus, and a folded-map objective HUD.
