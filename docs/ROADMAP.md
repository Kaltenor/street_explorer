...
- App-wide streamlined navy/gold presentation with a first-interaction collapsing map wordmark, textured Atlas dock navigation whose engraved selected destination expands to a localized Cinzel label, one engraved objective toggle, layer controls centralized in Options, a compact field-ledger recording card with neutral GPS inset, four-metric Completion, and collapsed technical diagnostics.
