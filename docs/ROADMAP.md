...
- District Expeditions V1: three deterministic offline district choices per local day, persisted concurrent expedition selection across districts, independent durable cell/street/loop/medal progress, permanent journal seals worth 200 retroactive Explorer Points each, a permanent Atlas navigation destination plus contextual multi-mission HUD shortcut, no-district handoff to Completion, and Backup V5 preservation.
