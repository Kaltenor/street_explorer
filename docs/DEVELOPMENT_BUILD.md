...
- Atlas page-turn navigation plus the two-second stereo medal orchestral cue and enclosure/expedition reward feedback through `expo-audio` and `expo-haptics`
- fixed 56-point seven-destination Atlas footer navigation, explicit Map selection, direct page switching without dock movement, map hold previews, and safe-area/Reduce Motion behavior
